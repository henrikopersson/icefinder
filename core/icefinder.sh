...
MAPNIK_MAP_FILE="/root/git/icefinder/core/image_cloud.xml" MAPNIK_TILE_DIR="/root/icefinder-tiles/$DATE_NASA" MAPNIK_MINZOOM="5" MAPNIK_MAXZOOM="11" python generate_tiles_imagery.py
